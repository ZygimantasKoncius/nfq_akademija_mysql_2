...
CREATE TABLE MaterialsTotal(total decimal);
INSERT INTO MaterialsTotal VALUES (NULL);

UPDATE MaterialsTotal SET MaterialsTotal.total = (SELECT SUM(JobsRegister_Materials.count) FROM JobsRegister_Materials) WHERE MaterialsTotal.total IS NULL;
